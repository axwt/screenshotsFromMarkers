...
var expScreenshotsUI = (function () {
    ...
    var folderPath = group1.add("statictext", [0, 0, 150, 25], undefined);
    ...
    function exportScreenshotsFromMarkers() {
        ...
        try {
            ...
            for (var k = comp.markerProperty.numKeys; k > 0; k--) {
                ...
                exportInfo.text = "Exporting screenshot from frame " + currentFrame + "...";
    ...
    var exportInfo = expScreenshotsUI.add("statictext", [0,0, 150, 25], undefined);
